...
def main():
    ...
    # Initialize ONNX Inference Session with specified provider
                ...
                if len(targets) > 0:
                    ...
                    if fovCircle:
                        if dist_from_center <= fovCircleSize:
                            ...
                            # Triggerbot: Press left mouse button automatically if there is a target in the FOV circle
    ...
    # Stop the camera when exiting the main loop
    camera.stop()
...
if __name__ == "__main__":
    try:
        ...
        print(str(e))
        print("Ask @Wonder for help in our Discord in the #ai-aimbot channel ONLY: https://discord.gg/rootkitorg or @MrBombs")
