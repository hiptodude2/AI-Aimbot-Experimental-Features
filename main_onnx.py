...
from config import aaMovementAmp, aaTriggerBotHeight, aaTriggerBotWidth, fovCircle, fovCircleSize, useMask, maskHeight, maskWidth, aaQuitKey, confidence, headshot_mode, cpsDisplay, visuals, onnxChoice, centerOfScreen, aaRecoilControl, aaRecoilControlAmp
...
def set_window_on_top(window):
    ...
    ctypes.windll.user32.SetWindowPos(hwnd, -1, 0, 0, 0, 0, 3)  # HWND_TOPMOST = -1
    ctypes.windll.user32.ShowWindow(hwnd, 1)  # SW_SHOWNOACTIVATE = 1
